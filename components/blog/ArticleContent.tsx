...
export function ArticleContent({ html }: { html: string }) {
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between rounded-lg border border-slate-200 bg-white px-3 py-2 text-slate-500">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-md hover:bg-slate-100 disabled:opacity-30"
          >
            <Minus size={14} />
          </button>
          ...
          <button
            ...
            className={cn(
              ...
              serif ? "bg-indigo-700 text-white" : "text-slate-500 hover:bg-slate-100 "
            )}
          >
            Serif
          </button>
